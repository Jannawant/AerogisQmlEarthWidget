...
class AnnotationLabelSourceFix : public LabelSource
{
public:
    AnnotationLabelSourceFix( const LabelSourceOptions& options )
        : LabelSource( options )
    {
        //nop
    }
                             ...
                             NumericExpression& priorityExpr )
    {
        ...
        PlaceNodeFix* node = new PlaceNodeFix(0L, point, style, context.getDBOptions());
...
class AnnotationLabelSourceFixDriver : public LabelSourceDriver
{
public:
    AnnotationLabelSourceFixDriver()
    {
        supportsExtension( "osgearth_label_annotation_fix", "FIXED osgEarth annotation label plugin" );
    }
    ...
    virtual ReadResult readObject(const std::string& file_name, const Options* options) const
    {
        ...
        return new AnnotationLabelSourceFix( getLabelSourceOptions(options) );
    }
};

REGISTER_OSGPLUGIN(osgearth_label_annotation, AnnotationLabelSourceFixDriver)
