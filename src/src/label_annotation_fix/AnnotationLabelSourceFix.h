 ...
 */
#ifndef OSGEARTH_DRIVER_FEATURE_SUB_MODEL_FIX_OPTIONS
#define OSGEARTH_DRIVER_FEATURE_SUB_MODEL_FIX_OPTIONS 1
...
#endif // OSGEARTH_DRIVER_FEATURE_SUB_MODEL_FIX_OPTIONS
